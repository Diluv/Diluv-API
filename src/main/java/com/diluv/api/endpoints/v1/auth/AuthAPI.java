...
public class AuthAPI extends RoutingHandlerPlus {
...
//        this.post("/refresh", this::refresh);
        this.get("/checkusername/{username}", "username", this::checkUsername);
    }
...
//            }
//
//            return this.generateToken(exchange, userRecord.getId(), userRecord.getUsername());
//        }
...
//    }
    ...
    private IResponse checkUsername (HttpServerExchange exchange, String username) {
