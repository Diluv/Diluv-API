...
//        TestUtil.runTest(httpClient, BASE_URL + "/eco/mods/projects", "{\"data\":{\"name\":\"Mods\",\"slug\":\"mods\",\"gameSlug\":\"eco\"}}");
    ...
    public void testProjectFilesByGameSlugAndProjectTypeAndProject () throws IOException {
        ...
        // TODO
//        TestUtil.runTest(httpClient, BASE_URL + "/minecraft/mods/crafttweaker/files", "{\"data\":{\"name\":\"Mods\",\"slug\":\"mods\",\"gameSlug\":\"eco\"}}");
//        TestUtil.runTest(httpClient, BASE_URL + "/minecraft/mods/bookshelf/files", "{\"data\":{\"name\":\"Bookshelf\",\"slug\":\"bookshelf\",\"summary\":\"Bookshelf summary\",\"description\":\"Bookshelf description\",\"logoUrl\":\"https://via.placeholder.com/150\",\"cachedDownloads\":32923285,\"createdAt\":1573482394,\"updatedAt\":1573482394}}");
    }
}